...
export interface GlowCardSpotlightProps {
  children: ReactNode;
  className?: string;
...
export function GlowCardSpotlight({
  children,
  className = "",
  glowColor = "blue",
  size = "md",
...
/** Alias usado em várias páginas (home, contato, pricing, etc.) */
export { GlowCardSpotlight as GlowCard };
export type GlowCardProps = GlowCardSpotlightProps;
