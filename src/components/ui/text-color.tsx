      ...
      <div className="mb-10 mt-4 md:mt-6">
        <div className="px-2">
          <div className="relative h-full w-full border border-slate-200 p-8 [mask-image:radial-gradient(200rem_24rem_at_center,white,transparent)] dark:border-slate-800">
            <h1 className="flex select-none flex-col px-3 py-2 text-center text-7xl font-extrabold leading-none tracking-tighter sm:text-8xl md:flex-col lg:flex-row">
