...
void main(){gl_Position=position;}`;
  ...
  private uniforms: ProgramUniforms = { resolution: null, time: null, u_color: null };
  ...
  render(now = 0) {
    ...
    if (uniforms.u_color) gl.uniform3fv(uniforms.u_color, this.color);
...
export const SmokeBackground: React.FC<SmokeBackgroundProps> = ({ smokeColor = "#808080", className }) => {
