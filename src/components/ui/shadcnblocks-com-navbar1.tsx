      ...
      <div className="container">
        <nav className="hidden justify-between lg:flex">
          ...
          <div className="flex gap-2">
            <a href={auth.login.url} className={buttonVariants({ variant: "outline", size: "sm" })}>{auth.login.text}</a>
            <a href={auth.signup.url} className={buttonVariants({ size: "sm" })}>{auth.signup.text}</a>
          </div>
        </nav>
              ...
              <SheetContent className="overflow-y-auto">
                ...
                <div className="my-6 flex flex-col gap-6">
                  ...
                  <div className="flex flex-col gap-3">
                    <a href={auth.login.url} className={buttonVariants({ variant: "outline" })}>{auth.login.text}</a>
                    <a href={auth.signup.url} className={buttonVariants({})}>{auth.signup.text}</a>
                  </div>
                </div>
              </SheetContent>
            </Sheet>
