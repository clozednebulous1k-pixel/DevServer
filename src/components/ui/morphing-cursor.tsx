...
export function MagneticText({ text = "CREATIVE", hoverText = "EXPLORE", className }: MagneticTextProps) {
  ...
  return (
    ...
    >
      <span className="text-5xl font-bold tracking-wide tracking-tighter text-foreground">{text}</span>
      ...
      >
        ...
        >
          <span className="text-5xl font-bold tracking-wide tracking-tighter whitespace-nowrap text-background">
            {hoverText}
          </span>
        </div>
      </div>
