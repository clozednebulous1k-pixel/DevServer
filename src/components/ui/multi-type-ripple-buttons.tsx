    ...
    return (
      <>
        ...
        <button
          type="button"
          className={cn(
            "relative isolate cursor-pointer overflow-hidden rounded-lg border-none bg-transparent px-4 py-2 text-lg",
        ...
        >
          ...
          >
            ...
            <div className="hover-variant-visual-ripple pointer-events-none absolute left-0 top-0 z-[-1] h-0 w-0 -translate-x-1/2 -translate-y-1/2 rounded-full" />
          </div>
        </button>
      </>
    );
      ...
      <>
        ...
        >
          ...
          >
            ...
            <div className="hoverborder-variant-visual-ripple pointer-events-none absolute left-0 top-0 z-[-1] h-0 w-0 -translate-x-1/2 -translate-y-1/2 rounded-full" />
          </div>
        </button>
      </>
    );
  ...
  return (
    <>
      ...
      <button
        type="button"
        className={cn(
          "relative isolate cursor-pointer overflow-hidden rounded-lg border-none bg-blue-600 px-4 py-2 text-lg text-white transition-all duration-200 hover:opacity-90",
