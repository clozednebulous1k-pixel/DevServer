...
export type BackgroundPreviewId =
  | "geometric"
  | "paths"
  | "beams"
  | "smoke"
...
export const clientCarouselPrompts: {
  id: string;
  title: string;
  description: string;
  prompt: string;
...
export type NavigationPreviewId = "navbar-1" | "header-1" | "header-3" | `abstract-${string}`;

export const navigationPrompts: {
  id: string;
  title: string;
  description: string;
  prompt: string;
